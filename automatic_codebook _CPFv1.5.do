...
**------------------------------------------------------------------------------
// Instert the main directory for storing original datasets and all the CPF files 
	
global your_dir "D:\__CPFv.1.5\"  // <--insert your directory 
global dir "${your_dir}\Codebook_CPF\"
...
do "${dir}prog_cpfbook_codebook.do"
...
cpfbookAavlb emplst5 emplst6 work_d work_py mater neverw un_act retf oldpens
...
cpfbookAavlb indust1 indust2 indust3	///
public
...
* NEXT PART
putdocx paragraph, style(Heading1)
putdocx text ("Ethnicity"), bold font("", 15)
*==============================================================================
...
* NEXT PART
putdocx paragraph, style(Heading1)
putdocx text ("Migration: Country of Birth and Family Migration Background"), bold font("", 15)
*==============================================================================
...
/*
//gets stuck here (0 invalid name)
foreach V in migr_f migr_m {
	local var `V' 
	pr1 `var', cat
	putdocx paragraph
